...
cor.station<-function(station) { # station is an integer in range 1:51
    ...
    cat(sprintf("| %-20s | %4.2f | %4.2f | %4.2f | %4.2f | %4.2f | %4.2f | %4.2f | %4.2f |\n",
     PP[[station]]$Station[1],
     slp.354,slp.356,slp.364,slp.366,at.354,at.356,at.364,at.366),
    file='correlations.md',append=TRUE)
}

cat("Stations with good data\n\n",file='correlations.md',append=FALSE)
cat("| Station  | SLP 3.5.4 | SLP 3.5.6 | SLP 3.6.4 | SLP 3.6.6 | AT 3.5.4 | AT 3.5.6 | AT 3.6.4 | AT 3.6.6 |\n",
    file='correlations.md',append=TRUE)
cat("| :------- |:---------:|:---------:|:--------:|:--------:|:--------:|:--------:|:--------:|:--------:|\n",
    file='correlations.md',append=TRUE)
