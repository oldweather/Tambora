...
c1<-get.anomaly.composite(c("1816-06-01:00","1816-06-30:23"),'3.6.6')
c2<-get.anomaly.composite(c("1816-07-01:00","1816-07-31:23"),'3.6.6')
c3<-get.anomaly.composite(c("1816-08-01:00","1816-08-31:23"),'3.6.6')

png(filename="1816_monthly_sst.png",width=412,height=768,pointsize=24)
